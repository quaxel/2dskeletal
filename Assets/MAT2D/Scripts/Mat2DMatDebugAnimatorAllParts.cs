...
namespace Mat2D
{
    ...
    public class Mat2DMatDebugAnimatorAllParts : MonoBehaviour
    {
        [Header("Material")]
        ...
        void RebuildTextures()
        {
            ...
            _mat0.name = "MAT0_Debug_AllParts";
            _mat1.name = "MAT1_Debug_AllParts";
            ...
            {
                float t = (float)y / height * Mathf.PI * 2f;
